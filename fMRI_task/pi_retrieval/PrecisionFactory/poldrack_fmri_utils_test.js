...
var fMRI_wait_block_initial = {
	type: 'poldrack-text',
	text: "<div class = centerbox>"+
			"<div  class = center-text>Task about to start! <br><br>Stay as still as possible.<br><br> Do not swallow.</div>"+
		  "</div>",
	cont_key: [84],
	data: {
...
var get_finger = function (choice) {
	var keycode_lookup = {'R': 'thumb', 'B': 'index finger', 'Y': 'middle finger', 
