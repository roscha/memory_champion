...
var fmri_scanner_wait_block = {
	...
	text: "<div class = centerbox>"+
			"<div  class = center-text>Scanner Setup <br><br>Stay as still as possible.<br><br> Do not swallow.</div>"+
		  "</div>",
	cont_key: [32],
	data: {
...
var fMRI_wait_block_initial = {
	type: 'poldrack-text',
	text: "<div class = centerbox>"+
			"<div  class = center-text>Normalization! <br><br>Stay as still as possible.<br><br> Do not swallow.</div>"+
		  "</div>",
	cont_key: [84],
	data: {
...
var get_finger = function (choice) {
	var keycode_lookup = {'R': 'thumb', 'Y': 'index finger', 'B': 'middle finger', 
					'G': 'ring finger', 'M': 'pinky finger'}//modified WashU
...
var create_key_test_block = function(choice) {
	...
	var key_test_block = {
		type: 'poldrack-text',
		text: "<div class = centerbox><div style = 'font-size: 25px' class = center-text>" + instruct_text + "</p></div>",
		cont_key: [choice],
		data: {
...
var cni_bore_setup = function(lst,prescan_str="<div  class = center-text>Scanner Setup <br><br>Stay as still as possible.<br><br> Do not swallow.</div>", prescan_cont_key=[32],wait_str="<div  class = center-text>Normalization! <br><br>Stay as still as possible.<br><br> Do not swallow.</div>", wait_cont_key=[84], wait_timing_response=10000 ) {
...
var cni_trigger_start = function(str="<div  class = center-text>Normalization! <br><br>Stay as still as possible.<br><br> Do not swallow.</div>", cont_key=[84]) {
	var cni_wait_block = {
		type: 'poldrack-text',
		text: "<div class = centerbox>"+ str + "</div>",
		cont_key: cont_key,
...
// block to wait for triggers
var cni_create_trigger_wait = function(str="<div  class = center-text>Normalization! <br><br>Stay as still as possible.<br><br> Do not swallow.</div>", timing_response=10000) {
    var fMRI_wait_block = {
        type: 'poldrack-text',
        text: "<div class = centerbox>"+ str + "</div>",
        cont_key: 'none',
